...
public class ConexionInicio {
	...
	//Método de prueba: Primero publicar información del servidor después obtener la IP
    public static void main(String[] args) throws IOException {
    	publicarInformacion();
    	obtenerIP();
       
    }
    public static void publicarInformacion() throws IOException{
    	// Make a URL to the web page
        URL url = new URL("http://pastebin.com/login.php");
    ...
    public static void obtenerIP() throws IOException{
    	 // Make a URL to the web page
